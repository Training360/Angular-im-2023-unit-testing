...
describe("CustomerEditorComponent", () => {
  ...
  it("customer should be the first customer in the list", (done) => {
    component.id = 1;
    component.ngOnInit();
  ...
  // Form testing /////////////////////////////////////////////////////////////
  it("the form shuld have a name field", (done) => {
    component.id = 1;
    component.ngOnInit();
  ...
  it("the name field shuld have an error if the value is too short", async () => {
    ...
    const formFieldHarness = await loader.getHarness<MatFormFieldHarness>(
      MatFormFieldHarness.with({ selector: 'form mat-form-field:first-child' })
    );
  ...
  it("click on the save button shuld be triggered the onUpdate method", async () => {
    component.id = 1;
    component.ngOnInit();
